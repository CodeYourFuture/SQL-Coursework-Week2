...
yf_ecommerce=> SELECT  products.product_name 
...
cyf_ecommerce=> SELECT  products.product_name, unit_price, suppliers.supplier_name 
                FROM product_availability  
                INNER JOIN products 
                ON product_availability.prod_id = products.id 
...
cyf_ecommerce=> SELECT  products.product_name, suppliers.supplier_name 
                FROM product_availability  
                INNER JOIN products 
                ON product_availability.prod_id = products.id 
                INNER JOIN suppliers 
...
cyf_ecommerce=> SELECT orders.id,orders.order_reference,orders.order_date, (quantity * product_availability.unit_price) 
                AS total_cost 
                FROM order_items 
                INNER JOIN orders 
...
SELECT customers.name, orders.order_reference, orders.order_date, product_availability.unit_price * order_items.quantity 
AS total_amount
FROM customers
INNER JOIN orders 
ON customers.id = orders.customer_id
